        ...
        const app = Vue.createApp({
            ...
            created() {
                ...
                this.design.forEach(element => {
                    ...
                    this.figuras[this.figuras.length-1].updateRelleno(element.fill_r, element.fill_g, element.fill_b, element.fill_a);
                    this.figuras[this.figuras.length-1].updateGrosor(element.thickness);
                    if(element.type==='line') {
                        this.figuras[this.figuras.length-1].updateLinea(element.x1, element.y1, element.x2, element.y2);
                    } else if(element.type!=='line') {
                        this.figuras[this.figuras.length-1].updateBorde(element.border_r, element.border_g, element.border_b, element.border_a);
                        this.figuras[this.figuras.length-1].updateMedidas(element.x, element.y, element.w, element.h);
